...
public class ListSupplier extends javax.swing.JFrame {
    ...
    public void cari(){
        ...
        try {
            Connection c = koneksi.getKoneksi();
            String sql = "Select * from supplier where " + cbCari.getSelectedItem() +" like '" + txCari.getText() + "%'";
     ...
     */
    public ListSupplier(char source) {
        initComponents();
    ...
    private void btnPilihActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPilihActionPerformed
        ...
        if (src == 'b'){
            ...
            DataBarang.txIDSupplier.setText(id);
            DataBarang.txNamaSupplier.setText(nama);
        }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new ListSupplier('a').setVisible(true);
        });
    }
