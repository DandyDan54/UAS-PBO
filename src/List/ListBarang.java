...
public class ListBarang extends javax.swing.JFrame {
    ...
    public void cari(){
        ...
        try {
            Connection c = koneksi.getKoneksi();
            String sql = "Select * from barang where " + cbCari.getSelectedItem() +" like '" + txCari.getText() + "%'";
    ...
    private void btnPilihActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPilihActionPerformed
        ...
        String harga = jTable1.getValueAt(i, 5).toString();
        ...
        if (src == 'j'){
            ...
            Pembelian.txNamaBarang.setText(nama);
            Pembelian.txHarga.setText(harga);
        }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ListBarang('a').setVisible(true);
            }
        });
    }
